...
class Transaksi extends Model
{
    ...
    protected $fillable = [
        ...
        'total_harga',
        'token',
        'status_pembayaran',  // Masih ada status_pembayaran untuk status transaksi
        'metode_pembayaran',  // Menambahkan metode_pembayaran
        'order_id',
    ];
    ...
    public function getTotalHargaAttribute()
    {
        ...
        // Jika belum ada, hitung dari detail transaksi (hanya sekali, bukan setiap kali akses)
