                ...
                <table class="table text-nowrap">
                    <thead>
                        <tr>
                            ...
                            <th class="border-top-0">Gambar Menu</th> <!-- Menambahkan kolom Gambar -->
                            <th class="border-top-0">Jumlah</th>
                            <th class="border-top-0">Total Harga</th>
                            <th class="border-top-0">Tanggal Transaksi</th>
                            <th class="border-top-0 text-white">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($transaksi->detailTransaksi->first() && $transaksi->detailTransaksi->first()->menu && $transaksi->detailTransaksi->first()->menu->gambar_menu)
                                    <img src="{{ asset('storage/' . $transaksi->detailTransaksi->first()->menu->gambar_menu) }}" alt="Gambar Menu" width="50" height="50">
                                @else
                                    <span>No Image</span>
                                @endif
                            </td>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <!-- Tampilkan gambar menu saat menghapus -->
                                                    @if($transaksi->detailTransaksi->first() && $transaksi->detailTransaksi->first()->menu && $transaksi->detailTransaksi->first()->menu->gambar_menu)
                                                        <img src="{{ asset('storage/' . $transaksi->detailTransaksi->first()->menu->gambar_menu) }}" alt="Gambar Menu" width="50" height="50">
                                                    @endif
                                                </div>
